...
$stmt = $db->prepare("insert into Blazers_team_data values(?,?,?,?,?)");
...
function ImportBlazersNewTeamRosterAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Blazers_newteam_roster values(?,?,?,?,?,?,?)");
...
function ImportBlazersTeamPayRollAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Blazers_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `Blazers_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
function ImportalfarouqaminuSeasonStatsAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into al_farouq_aminu values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportCJMcCollumSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into CJ_McCollum values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportdamianlillardSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into damian_lillard values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportEdDavisSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into ed_davis values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportevanturnerSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into evan_turner values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportjakelaymanSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into jake_layman values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportjusufnurkicSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into jusuf_nurkic values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportmauriceharklessStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into maurice_harkless values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMeyersLeonardSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Meyers_Leonard values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportPatConnaughtonsonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Pat_Connaughton values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportshabazznapierSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into shabazz_napier values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportwadebaldwinivSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into wade_baldwin values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportrzachcollinsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into zach_collins values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportCalebSwaniganSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Caleb_Swanigan values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportCJWilcoxSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into C_J_Wilcox values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportBlazersPlayersSeasonStatsAndInsertIntoMysqlDB(){
	

	try {
 ImportCJMcCollumSeasonStatsAndInsertIntoMysql();
	usleep(mt_rand(15000000,25000000));
ImportEdDavisSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMeyersLeonardSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportPatConnaughtonsonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportalfarouqaminuSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportevanturnerSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportjakelaymanSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportjusufnurkicSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportmauriceharklessStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportrzachcollinsSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportwadebaldwinivSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportdamianlillardSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportshabazznapierSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportCalebSwaniganSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportCJWilcoxSeasonStatsAndInsertIntoMysql();
