...
//1.import team data
function ImportClippersTeamDataAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into Clippers_team_data values(?,?,?,?,?)");
...
function ImportClippersNewTeamRosterAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Clippers_newteam_roster values(?,?,?,?,?,?,?)");
...
function ImportClippersTeamPayRollAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Clippers_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `Clippers_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
function ImportAustinRiversSeasonStatsAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into Austin_Rivers values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportAveryBradleySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Avery_Bradley values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportBobanMarjanovicSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Boban_Marjanovic values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportCJWilliamsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into C_J_Williams values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDaniloGallinariSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Danilo_Gallinari values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDeAndreJordanSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into DeAndre_Jordan values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJamilWilsonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jamil_Wilson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportLouWilliamsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Lou_Williams values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMilosTeodosicSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Milos_Teodosic values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMontrezlHarrellSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Montrezl_Harrell values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportPatrickBeverleySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Patrick_Beverley values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportSamDekkerSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Sam_Dekker values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportSindariusThornwellSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Sindarius_Thornwell values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportTobiasHarrisSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Tobias_Harris values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportWesleyJohnsonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Wesley_Johnson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJawunEvansSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jawun_Evans values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportClippersPlayersSeasonStatsAndInsertIntoMysqlDB(){
	

	try {

ImportAustinRiversSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportAveryBradleySeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportBobanMarjanovicSeasonStatsAndInsertIntoMysql();\
usleep(mt_rand(15000000,25000000));
ImportCJWilliamsSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDaniloGallinariSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDeAndreJordanSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJamilWilsonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportLouWilliamsSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMilosTeodosicSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMontrezlHarrellSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportPatrickBeverleySeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportSamDekkerSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportSindariusThornwellSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportTobiasHarrisSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportWesleyJohnsonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJawunEvansSeasonStatsAndInsertIntoMysql();
