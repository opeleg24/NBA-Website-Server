...
//1.import team data
function ImportMavsTeamDataAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into mavs_team_data values(?,?,?,?,?)");
...
function ImportMavsNewTeamRosterAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into mavs_newteam_roster values(?,?,?,?,?,?,?)");
...
function ImportMavsTeamPayRollAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into mavs_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `mavs_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
function ImportAaronHarrisonSeasonStatsAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into Aaron_Harrison values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDennisSmithJrSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Dennis_Smith_Jr values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDirkNowitzkiSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Dirk_Nowitzki values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDorianFinneySmithSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Dorian_Finney_Smith values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDougMcDermottSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Doug_McDermott values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDwightPowellSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Dwight_Powell values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportHarrisonBarnesSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Harrison_Barnes values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJJBareaSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into J_J_Barea values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJeffWitheySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jeff_Withey values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJoshMcRobertsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Josh_McRoberts values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMaxiKleberSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Maxi_Kleber values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportNerlensNoelSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Nerlens_Noel values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportSalahMejriSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Salah_Mejri values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportSethCurrySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Seth_Curry values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportWesleyMatthewsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Wesley_Matthews values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
foreach($ArrayNewRoster as $row){
   ...
   $stmt->execute();
    ...
    function ImportYogiFerrellSeasonStatsAndInsertIntoMysql(){
...
//Site where data is scrapped:$html = file_get_html();
    ...
    $db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
    $stmt = $db->prepare("insert into Yogi_Ferrell values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    function ImportJohnathanMotleySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Johnathan_Motley values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
foreach($ArrayNewRoster as $row){
   ...
   $stmt->execute();
    ...
    function ImportJalenJonesSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jalen_Jones values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMavsPlayersSeasonStatsAndInsertIntoMysqlDB(){
	

	try {
ImportAaronHarrisonSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportDennisSmithJrSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportDirkNowitzkiSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportDorianFinneySmithSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportDougMcDermottSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportDwightPowellSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportHarrisonBarnesSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportJJBareaSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportJeffWitheySeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportJoshMcRobertsSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportMaxiKleberSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportNerlensNoelSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportSalahMejriSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportSethCurrySeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportWesleyMatthewsSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportYogiFerrellSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportJohnathanMotleySeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportJalenJonesSeasonStatsAndInsertIntoMysql();
