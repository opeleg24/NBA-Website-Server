...
//1.import team data
function ImportRaptorsTeamDataAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into raptors_team_data values(?,?,?,?,?)");
...
function ImportRaptorsNewTeamRosterAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Raptors_newteam_roster values(?,?,?,?,?,?,?)");
...
function ImportRaptorsTeamPayRollAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Raptors_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `Raptors_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
function ImportCJMilesSeasonStatsAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into C_J_Miles values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDeMarDeRozanSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into DeMar_DeRozan values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDelonWrightSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Delon_Wright values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportFredVanVleetSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Fred_VanVleet values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJakobPoeltlSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jakob_Poeltl values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJonasValanciunasSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jonas_Valanciunas values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportKyleLowrySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Kyle_Lowry values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportLucasNogueiraStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Lucas_Nogueira values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMalachiRichardsonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Malachi_Richardson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportNormanPowellSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Norman_Powell values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportOGAnunobySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into OG_Anunoby values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportPascalSiakamStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Pascal_Siakam values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportSergeIbakaSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Serge_Ibaka values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportLorenzoBrownSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Lorenzo_Brown values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportRaptorsPlayersSeasonStatsAndInsertIntoMysqlDB(){
	

	try {

ImportCJMilesSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDeMarDeRozanSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDelonWrightSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportFredVanVleetSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJakobPoeltlSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJonasValanciunasSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportKyleLowrySeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportLucasNogueiraStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMalachiRichardsonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportNormanPowellSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportOGAnunobySeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportPascalSiakamStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportSergeIbakaSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportLorenzoBrownSeasonStatsAndInsertIntoMysql();
