...
$stmt = $db->prepare("insert into Spurs_team_data values(?,?,?,?,?)");
...
function ImportSpursNewTeamRosterAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Spurs_newteam_roster values(?,?,?,?,?,?,?)");
...
function ImportSpursTeamPayRollAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Spurs_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `Spurs_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
function ImportBrynForbesSeasonStatsAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into Bryn_Forbes values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDannyGreenSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Danny_Green values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDavisBertansSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Davis_Bertans values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDejounteMurraySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Dejounte_Murray values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDerrickWhiteSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Derrick_White values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJoffreyLauvergneSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Joffrey_Lauvergne values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportKawhiLeonardSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Kawhi_Leonard values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportKyleAndersonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Kyle_Anderson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportLaMarcusAldridgeSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into LaMarcus_Aldridge values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportManuGinobiliSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Manu_Ginobili values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportPattyMillsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Patty_Mills values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportPauGasolStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Pau_Gasol values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportRudyGaySeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Rudy_Gay values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportTonyParkerSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Tony_Parker values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportSpursPlayersSeasonStatsAndInsertIntoMysqlDB(){
	

	try {
ImportBrynForbesSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDannyGreenSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDavisBertansSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDejounteMurraySeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDerrickWhiteSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJoffreyLauvergneSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportKawhiLeonardSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportKyleAndersonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportLaMarcusAldridgeSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportManuGinobiliSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportPattyMillsSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportPauGasolStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportRudyGaySeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportTonyParkerSeasonStatsAndInsertIntoMysql();
