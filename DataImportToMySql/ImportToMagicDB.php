...
$stmt = $db->prepare("insert into magic_team_data values(?,?,?,?,?)");
...
function ImportMagicNewTeamRosterAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Magic_newteam_roster values(?,?,?,?,?,?,?)");
...
function ImportMagicTeamPayRollAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into Magic_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `Magic_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
function ImportAaronGordonSeasonStatsAndInsertIntoMysql(){
...
$stmt = $db->prepare("insert into Aaron_Gordon values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportAdreianPayneSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Adreian_Payne values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportArronAfflaloSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Arron_Afflalo values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportBismackBiyomboSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Bismack_Biyombo  values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDJAugustinSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into D_J_Augustin values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportEvanFournierSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Evan_Fournier values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJonathanIsaacSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jonathan_Isaac values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJonathonSimmonsStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jonathon_Simmons values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMarioHezonjaSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Mario_Hezonja values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMarreeseSpeightsSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Marreese_Speights values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportNikolaVucevicSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Nikola_Vucevic values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportRashadVaughnSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Rashad_Vaughn values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportShelvinMackSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Shelvin_Mack values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportTerrenceRossSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Terrence_Ross values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJamelArtisSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jamel_Artis values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportKhemBirchSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Khem_Birch values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportWesIwunduSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Wesley_Iwundu values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMagicPlayersSeasonStatsAndInsertIntoMysqlDB(){
	

	try {


 ImportAaronGordonSeasonStatsAndInsertIntoMysql();
 usleep(mt_rand(15000000,25000000));
ImportAdreianPayneSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportArronAfflaloSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportBismackBiyomboSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDJAugustinSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportEvanFournierSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJonathanIsaacSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJonathonSimmonsStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMarioHezonjaSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMarreeseSpeightsSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportNikolaVucevicSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportRashadVaughnSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportShelvinMackSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportTerrenceRossSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJamelArtisSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportKhemBirchSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportWesIwunduSeasonStatsAndInsertIntoMysql();
