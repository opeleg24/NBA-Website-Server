...
$stmt = $db->prepare("insert into sixers_team_data values(?,?,?,?,?)");
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into sixers_newteam_roster values(?,?,?,?,?,?,?)");
...
$db = new PDO('mysql:host=localhost;dbname=teams' ,'root','R98sc30lb337%');
$stmt = $db->prepare("insert into sixers_team_payroll values(?,?,?,?,?,?,?,?,?,?)");
...
//This deletes the empty row just before the total team and another contract player.
   $stmt = $db->prepare("DELETE FROM `sixers_team_payroll` WHERE `Player`='';");
   $stmt->execute();
} 
} catch (Exception $e) {
    echo $e->getMessage();
...
$stmt = $db->prepare("insert into Ben_Simmons values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportAmirJohnsonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Amir_Johnson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDarioSaricSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Dario_Saric values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportErsanIlyasovaSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Ersan_Ilyasova values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportFurkanKorkmazSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Furkan_Korkmaz values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJJRedickSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into J_J_Redick values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJahlilOkaforSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jahlil_Okafor values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJamesMichaelMcAdooSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into James_Michael_McAdoo values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJerrydBaylessSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Jerryd_Bayless values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJoelTrustTheProcessEmbiidSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Joel_Embiid values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportJustinAndersonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Justin_Anderson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMarcoBelinelliSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Marco_Belinelli values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportMarkelleFultzSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Markelle_Fultz values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportNikStauskasSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Nik_Stauskas values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportRichaunHolmesSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Richaun_Holmes values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportRobertCovingtonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Robert_Covington values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportTJMcConnellSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into T_J_McConnell values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportDemetriusJacksonSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Demetrius_Jackson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
function ImportTimotheLuwawuCabarrotSeasonStatsAndInsertIntoMysql(){
...
$db = new PDO('mysql:host=localhost;dbname=players_season_pergame','root','R98sc30lb337%');
$stmt = $db->prepare("insert into Timothe_Luwawu_Cabarrot values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
ImportAmirJohnsonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportBenSimmonsSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDarioSaricSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportErsanIlyasovaSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportFurkanKorkmazSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJJRedickSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJahlilOkaforSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJamesMichaelMcAdooSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJerrydBaylessSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJoelTrustTheProcessEmbiidSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportJustinAndersonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMarcoBelinelliSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportMarkelleFultzSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportNikStauskasSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportRichaunHolmesSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportRobertCovingtonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportTJMcConnellSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportDemetriusJacksonSeasonStatsAndInsertIntoMysql();
usleep(mt_rand(15000000,25000000));
ImportTimotheLuwawuCabarrotSeasonStatsAndInsertIntoMysql();
